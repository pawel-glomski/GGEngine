...
#include "Modules/World/Systems/DisplaySystem.h"
#include "Modules/World/Systems/CollisionSystem/CollisionSystem.h"
#include "Modules/World/Systems/PhysicsSystem.h"
#include "Modules/World/Systems/InteractionSystem.h"
...
void WorldModule::startUp()
{
	...
	world.makeSystem<DisplaySystem>(getDependency<DisplayModule>(), world.getSystem<CollisionSystem>(), world.getSystem<InteractionSystem>());
